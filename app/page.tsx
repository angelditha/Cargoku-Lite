  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] font-sans flex flex-col">
      ...
      <section className="relative -mt-16 px-6 z-10 max-w-4xl mx-auto w-full">
        <div className="bg-white rounded-2xl shadow-xl p-6 border border-slate-100">
          ...
          <div className="flex justify-center gap-12 border-b mb-6">
            <button className="pb-3 text-sm font-bold text-[#bd3232] border-b-2 border-[#bd3232]">
              Cek Resi
            </button>
            <button className="pb-3 text-sm font-bold text-slate-400 hover:text-slate-600 border-b-2 border-transparent">
              Cek Ongkir
            </button>
          </div>
      ...
      <section className="pb-24 px-6 max-w-5xl mx-auto w-full text-center">
        <h2 className="text-2xl md:text-3xl font-black italic text-slate-800 mb-2">
          Layanan Pengiriman
        </h2>
      ...
      <footer className="mt-auto py-8 text-center border-t border-slate-200">
        <p className="text-xs font-bold text-slate-400">
          © 2026 CargoKu Lite Indonesia. All Rights Reserved.
        </p>
      </footer>
